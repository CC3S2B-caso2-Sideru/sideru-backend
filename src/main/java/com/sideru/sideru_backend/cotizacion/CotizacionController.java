...
public class CotizacionController {
    ...
    @PostMapping
    @PreAuthorize("hasRole('cliente') or hasAuthority('ventas.cotizacion.crear')")
    ...
    @PreAuthorize("hasRole('cliente') or hasAuthority('ventas.cotizacion.ver')")
    ...
    @PreAuthorize("hasAuthority('ventas.cotizacion.ver')")
    ...
    @PreAuthorize("hasAuthority('ventas.cotizacion.aprobar')")
